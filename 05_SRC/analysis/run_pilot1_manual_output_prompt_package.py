...
SCRIPTS = [
    ...
    REPO_ROOT / "05_SRC" / "analysis" / "pilot1_manual_output_prompt_view.py",
    REPO_ROOT / "05_SRC" / "analysis" / "pilot1_manual_output_prompt_export.py",
...
def main():
    for script in SCRIPTS:
        run_script(script)
    print("Pilot 1 manual output prompt package complete.")
